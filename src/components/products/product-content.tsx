...
const products = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 156,
    image: "/product-hinge-1.png",
    isOnSale: true,
    isFeatured: false,
    description: "Durable steel hinge for heavy doors with smooth operation",
  },
  {
    id: 4,
    name: "Solid Wood Entry Door",
    category: "Doors",
    price: 899.99,
    rating: 4.6,
    reviews: 67,
    image: "/product-door-1.png",
    isOnSale: false,
    isFeatured: true,
    description: "Handcrafted solid wood door with elegant finish",
  },
  {
    id: 5,
